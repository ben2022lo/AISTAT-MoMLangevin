    ...
    def update_step(self, gradient, variable):
        ...
        if isinstance(gradient, tf.IndexedSlices):
            ...
            add_value = tf.IndexedSlices(
                -(gradient.values * lr)+tf.math.sqrt(lr)*tf.random.normal(gradient.shape), gradient.indices #SGLD Step
            )
            ...
            if m is not None:
                ...
                variable.assign_add(-(gradient * lr) + tf.math.sqrt(lr)*tf.random.normal(gradient.shape)) #SGLD Step
